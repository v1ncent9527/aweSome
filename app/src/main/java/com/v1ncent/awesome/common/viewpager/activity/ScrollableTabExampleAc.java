...
import com.v1ncent.awesome.common.viewpager.ext.titles.ColorFlipPagerTitleView;
...
public class ScrollableTabExampleAc extends BaseActivity {
    ...
    private ScrollableTabExampleAc context;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scrollable_tab_example);
    ...
    private void initMagicIndicator2() {
        magicIndicator2.setBackgroundColor(ContextCompat.getColor(context, R.color.primary));
        CommonNavigator commonNavigator = new CommonNavigator(this);
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                simplePagerTitleView.setNormalColor(ContextCompat.getColor(context, R.color.primary_light));
    ...
    private void initMagicIndicator3() {
        magicIndicator3.setBackgroundColor(ContextCompat.getColor(context, R.color.black_21));
        CommonNavigator commonNavigator = new CommonNavigator(this);
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
    ...
    private void initMagicIndicator6() {
        ...
        magicIndicator6.setNavigator(commonNavigator);
