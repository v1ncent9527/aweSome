...
import com.v1ncent.awesome.common.viewpager.ext.titles.ScaleTransitionPagerTitleView;
...
public class BadgeTabExampleAc extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{"PDD", "White", "Cool"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fbadge_tab);
        ...
        getSupportActionBar().setTitle("ScrollableTabExample");
    ...
    private void initMagicIndicator4() {
        ...
        titleContainer.setDividerDrawable(new ColorDrawable() {
            ...
            public int getIntrinsicWidth() {
                return UIUtil.dip2px(BadgeTabExampleAc.this, 15);
            }
        });
