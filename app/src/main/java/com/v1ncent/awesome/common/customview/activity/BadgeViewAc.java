...
/**
 * Created by v1ncent on 2017/8/10.
 */

public class BadgeViewAc extends BaseActivity {
    ...
    private void initView() {
        ...
        getSupportActionBar().setTitle("BadgeView");
    ...
    private void initBadge() {
        ...
        badges.add(new QBadgeView(this).bindTarget(imageview).setBadgeText("PNG").setBadgeTextColor(0x00000000)
                ...
                .setBadgeBackground(getResources().getDrawable(R.drawable.simple_splitter)));
